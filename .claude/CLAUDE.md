...
- プレミアム版は同名カードとして扱い、**枚数は通常版と合算**する
...
| レアリティ | 確率 |
|---|---|
| エクスチェンジチケット（4種）→ **プレミアカードとして扱う** | 0.060% |
| レジェンド | 1.500% |
| ゴールドレア | 6.000% |
| シルバーレア | 25.000% |
| ブロンズレア | 67.440% |
...
- **プレミアム**: 各カードは **8.0%** の確率でプレミアム版として排出される（レアリティ抽選とは独立）
- **エクスチェンジチケット枠の扱い**: 本アプリではチケットに意味がないため、この 0.060% 枠は**プレミアム確定のカード**を排出する
